...
# ===========================
st.markdown("""
    # Agentic RAG powered by <img src="data:image/png;base64,{}" width="80" style="vertical-align: -3px;">
""".format(base64.b64encode(open("assets/groq.png", "rb").read()).decode()), unsafe_allow_html=True)
